...
QtObject {
    ...
    readonly property int smallFontPointSize : 8          // 主页面下的icon的文本例如chat等
    readonly property int middleFontPointSize : 11
    readonly property int normalFontPointSize : 14        // 文本编辑框，按钮中的字体大小
    readonly property int bigFontPointSize : 18              // 软件标题
    ...
    readonly property url iconsPath: "../../assets/resource/icons/"
    ...
    readonly property url momentsLikeIconed: icons.labelIcon("like-2")                      //点赞的图标
